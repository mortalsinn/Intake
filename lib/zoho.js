...
function buildPhotoPermissionNote({ count, mayShare, statement, at, showName }) {
    const lines = [
        ...
        mayShare
            ? '  The customer ticked the sharing box, so these photographs may be\n'
              + '  used on social media, the website and in printed materials.\n'
              + '  Their name, address and contact details must not be shown.'
...
module.exports = {
    ...
    createAttachment, canWriteAttachments, verifyConnection, buildPhotoPermissionNote,
